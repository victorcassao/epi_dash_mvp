...
class AlertsListScreen extends GetView<AlertsListController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Alertas da Empresa"),
        actions: [
          IconButton(
          ...
          Row(
            children: [
              IconButton(
                ...
                onPressed: () {
                  Get.toNamed(
                    '/company/${controller.companyId}/cameras/${alert.cameraId}/alerts',
                  );
                },
              ),
              IconButton(
                icon: const Icon(Icons.info),
                tooltip: 'Ver notificações geradas',
                onPressed: () {
                  null;
                },
              ),
